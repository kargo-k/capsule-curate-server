...
def nordy(url, category, category2)
  ...
  if collection.count == 52
    next_page = obj.css('span._3xquK')
  end

end

nordy('https://shop.nordstrom.com/c/sustainable-style?breadcrumb=Home%2FSustainable%20Style&flexi=60126782_60126784&flexi=8000786_8000819', 'outerwear', 'outerwear')